...
<div className="min-h-screen mt-10 p-6 bg-gray-100 flex items-center justify-center">
  <div className="container max-w-screen-lg mx-auto">
    <div>
      <h2 className="font-semibold text-xl text-gray-600">muddy House</h2>
      <p className="text-gray-500 mb-6">Fill Out All the Details</p>
        ...
        <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <div className="md:col-span-2">
                <label htmlFor="adahar">Addahar Card Number</label>
                <input type="text" name="adahar" id="adahar" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50"  placeholder="xxxx-xxxx-xxxx" />
              </div>
              <div className="md:col-span-2">
                <label htmlFor="date">Date</label>
                <input type="date" name="date" id="date" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50"  placeholder />
              </div>
              <div className="md:col-span-2">
...
<form class="max-w-sm mx-auto">
  ...
  <select id="countries" name='country' class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    <option value={id.name}>{id.name}</option>
              ...
              <div className="md:col-span-2">
                <label htmlFor="soda">How many rooms?</label>
                <div className="h-10 w-28 bg-gray-50 flex border border-gray-200 rounded items-center mt-1">
                  <button tabIndex={-1} htmlFor="show_more" onClick={() => setCount(count -1)} className="cursor-pointer outline-none focus:outline-none border-r border-gray-200 transition-all text-gray-500 hover:text-blue-600">
                  ...
                  <input name="soda" id="soda" placeholder={count} className="px-2 text-center appearance-none outline-none text-gray-800 w-full bg-transparent" />
                  <button tabIndex={-1} onClick={() => setCount(count + 1)} htmlFor="show_more" className="cursor-pointer outline-none focus:outline-none border-l border-gray-200 transition-all text-gray-500 hover:text-blue-600">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto">
                  <p className="my-4 text-blueGray-500 text-lg leading-relaxed">
                    <p className='flex gap-2 mb-16'>Do You Want To Add Meal?</p>

               <div>
  <div className="flex items-center mb-4">

    <input id="default-radio-1" type="radio" defaultValue name="default-radio" value="yes" onClick={()=>setData(1)} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
    <label htmlFor="default-radio-1" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>


  </div>
  <div className="flex items-center">
    <input defaultChecked id="default-radio-2" type="radio" defaultValue name="default-radio" onClick={()=>setData(0)} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
